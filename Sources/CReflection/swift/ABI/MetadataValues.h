...
#ifndef OPENCOMBINE_SWIFT_ABI_METADATAVALUES_H
#define OPENCOMBINE_SWIFT_ABI_METADATAVALUES_H
...
public:
  ...
  static bool needsWitnessTable(ProtocolDispatchStrategy strategy) {
    ...
    opencombine_swift_runtime_unreachable("Unhandled ProtocolDispatchStrategy in switch.");
  }
...
#endif // OPENCOMBINE_SWIFT_ABI_METADATAVALUES_H
