  ...
  func testTop() {
    ...
    XCTAssertEqual(
      ...
      .constraints(
        [
          Constraint.top(
            Top(target: .external(.parent), constant: 0.0, multiplier: 1.0)
          ),
        ]
      )
    )
  ...
  func testBottom() {
    ...
    XCTAssertEqual(
      ...
      .constraints(
        [
          Constraint.bottom(
            Bottom(target: .external(.parent), constant: 0.0, multiplier: 1.0)
          ),
        ]
      )
    )
  ...
  func testLeft() {
    ...
    XCTAssertEqual(
      ...
      .constraints(
        [
          Constraint.left(
            Left(target: .external(.parent), constant: 0.0, multiplier: 1.0)
          ),
        ]
      )
    )
  ...
  func testRight() {
    ...
    XCTAssertEqual(
      ...
      .constraints(
        [
          Constraint.right(
            Right(target: .external(.parent), constant: 0.0, multiplier: 1.0)
          ),
        ]
      )
    )
  ...
  func testLeading() {
    ...
    XCTAssertEqual(
      ...
      .constraints(
        [
          Constraint.leading(
            Leading(target: .external(.parent), constant: 0.0, multiplier: 1.0)
          ),
        ]
      )
    )
